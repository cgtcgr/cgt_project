...
void CMagDevice::SetEnhancedROI(UINT intChannelIndex, UINT intEnhancedRatio, UINT x0, UINT y0, UINT x1, UINT y1)
{
#ifdef MAG_Linux_Not_Implemented
	//
#else
...
int CMagDevice::GetLineTemperatureInfo2(UINT x0, UINT y0, UINT x1, UINT y1, int info[3])
{
#ifdef MAG_Linux_Not_Implemented
	return FALSE;
#else
