...
#define LanguageFile "./translations/transEnglish.qm"

#ifndef MYHELPER_H
#define MYHELPER_H


#include "form/userframe/frmessagebox.h"
...
//    }
    ...
    {
        frmessagebox::Instance()->setMessage(info, 0, closeSec);
    ...
    //显示错误框,仅确定按钮 非模态
    static void showMessageBoxErrorX(QString info, int closeSec = 0,QString info2 = "")
    {
        frmessagebox::Instance()->setMessage(info, 2, closeSec,info2);
        frmessagebox::Instance()->show();
    }

    //显示询问框,确定和取消按钮
    static int showMessageBoxQuestion(QString info,QString tips2 = "")
    {
        frmessagebox msg;
        msg.setMessage(info, 1,0,tips2);
        return msg.exec();
    }
